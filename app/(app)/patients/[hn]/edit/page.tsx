...
export default async function EditPatientPage({ params }: { params: Promise<{ hn: string }> }) {
  ...
  return (
    <div className="mx-auto max-w-3xl">
      <BackButton fallbackHref={`/patients/${patient.hn}`} />
      <h1 className="text-lg font-bold text-teal-900">แก้ไขข้อมูลผู้ป่วย</h1>
      <p className="mb-4 text-sm text-ink-soft">HN {patient.hn}</p>
